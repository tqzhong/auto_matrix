...
export const FILM_SCENES: FilmScene[] = [
  ...
  scene('m1_mirror', 1, 'lafayette', 'neo', '镜面与定位', 'pill', 'awakening', '房间里的设备追踪你的真实身体，裂开的镜面开始复原。', [use('触碰裂镜', '镜面附着在手臂上，接线组终于定位到培养舱。回到设备旁，让连接完成。', MIRROR_TOUCH.x, MIRROR_TOUCH.z, 8), use('坐到连接椅上', '定位信号穿过模拟世界，熟悉的房间从感官中消失。', 8, 5)], ['morpheus', 'trinity']),
