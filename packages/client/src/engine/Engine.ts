...
export class Engine {
  ...
  setSandbox(state: SandboxState, agents: Record<string, AgentState>): void {
    ...
    if (this.playerControls) {
      ...
      this.playerControls.ride = journey?.actor === this.playerControls.id && !journey.visiting ? journey.hammer?.phase === 'riding' ? journey.hammer : journey.garage?.phase === 'riding' ? journey.garage : journey.ride?.phase === 'riding' ? journey.ride : undefined : undefined;
